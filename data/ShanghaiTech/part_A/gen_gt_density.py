...
if __name__ == "__main__":
    ...
    root_dirs = ["/content/data/train_data", "/content/data/test_data"]
    anno_files = ["/content/Few-Shot-Object-Counting-PyTorch/data/ShanghaiTech/part_A/train.json", "/content/Few-Shot-Object-Counting-PyTorch/data/ShanghaiTech/part_A/test.json"]

    for anno_file, root_dir in zip(anno_files, root_dirs):
        img_dir = os.path.join(root_dir, "img")
        gt_dir = os.path.join(root_dir, "density1")
